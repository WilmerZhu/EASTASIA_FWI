...
class GCMTPlotter:
    ...
    def __init__(self, config_file: Optional[Path] = None, output_dir: Optional[str] = None):
        ...
        # 自动提取模块号（从文件名如 5_2_GCMT.py 提取 5-2）
        self.module_prefix = extract_module_prefix(Path(__file__), default="5-2")
    ...
    def _print_config_summary(self):
        ...
        print(f"图片分辨率: jpg {output['dpi_jpg']}dpi, PDF {output['dpi_pdf']}dpi")
    ...
    def _generate_filename(self, description: str, extension: str = "jpg") -> str:
        ...
        Args:
            description: 图片描述（如 'GCMT_focal_mechanisms'）
            extension: 文件扩展名（默认 'jpg'）
            
        Returns:
            符合规范的完整文件名，如 '5-2_GCMT_focal_mechanisms.jpg'
        """
        return generate_filename(self.module_prefix, description, extension)
    ...
    def plot_focal_mechanisms_map(self, 
        ...
        if save_file is None:
            save_file = self._generate_filename("GCMT_focal_mechanisms")
                ...
                try:
                    ...
                    if all(col in event.index and pd.notna(event[col]) for col in required_cols):
                        ...
                        fig.meca(
                            ...
                            extension_fill=focal_config['extension_fill'],
    ...
    def plot_comprehensive_statistics(self, 
        ...
        # 如果没有指定文件名，自动生成
        if save_file is None:
            save_file = self._generate_filename("GCMT_comprehensive_analysis")
    ...
    def plot_all_gcmt_analysis(self, 
                              ...
                              use_mb: Optional[bool] = None,
                              use_ms: Optional[bool] = None,
                              min_magnitude_for_meca: Optional[float] = None,
